...
import uk.co.richardgoater.stats.tests.mock.SelectionDAOMockImpl;
...
public class SeasonSelectorTest {
	...
	ScheduleDAO selectionDao = new SelectionDAOMockImpl();
	StatsDAO statsDao = new StatsDAOMockImpl();
